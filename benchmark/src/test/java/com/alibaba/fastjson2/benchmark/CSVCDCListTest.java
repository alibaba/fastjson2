...
public class CSVCDCListTest {
    static final CSVCDCList benchmark = new CSVCDCList();
    ...
    public static void rowCount() throws Exception {
        for (int j = 0; j < COUNT; j++) {
            ...
            System.out.println("CDCList-rowCount millis : " + millis);
            // zulu8.62.0.19 :
        }
    }
    ...
    public static void readLines() throws Exception {
        for (int j = 0; j < COUNT; j++) {
            ...
            long millis = System.currentTimeMillis() - start;
            System.out.println("CDCList-readLines millis : " + millis);
            // zulu8.62.0.19 :
        }
    }
