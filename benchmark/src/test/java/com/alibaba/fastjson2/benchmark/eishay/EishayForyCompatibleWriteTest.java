...
public class EishayForyCompatibleWriteTest {
    static final EishayForyCompatibleWrite benchmark = new EishayForyCompatibleWrite();
    ...
    public static void jsonb() throws Exception {
        ...
        for (int j = 0; j < 5; j++) {
            ...
            System.out.println("EishayForyCompatibleWrite-jsonb millis : " + millis);
    ...
    public static void fory() throws Exception {
        System.out.println("fory size " + benchmark.forySize()); // 661 502
        for (int j = 0; j < 5; j++) {
            long start = System.currentTimeMillis();
            for (int i = 0; i < COUNT; ++i) {
                benchmark.fory(BH);
            ...
            long millis = System.currentTimeMillis() - start;
            System.out.println("EishayForyCompatibleWrite-fory millis : " + millis);
