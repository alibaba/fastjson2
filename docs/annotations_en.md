...
Starting from version 2.0.61, configure @JSONField(skipTransient = false) on transient fields or getter methods annotated with @java.beans.Transient. This can force serialization of transient fields.
```java
public class Bean1 {
...
Starting from version 2.0.61, you can configure the mandatory serialization of transient properties through ` @ JSONType (skipTransient=false) `.
