...
//                        throw new JSONException("encodeUTF8 error", new MalformedInputException(1));
    ...
    public final void writeUUID(UUID value) {
        int off = this.off;
        byte[] buf = IO.ensureCapacity(this, off + IO.valueSize(value));
    ...
    public abstract static class IO {
        ...
        public static int writeStringLatin1(JSONWriterUTF8 writer, byte[] buf, int off, byte[] value, long features) {
            ...
            return StringUtils.writeLatin1(buf, off, value, quote);
        }
...
//                        throw new JSONException("encodeUTF8 error", new MalformedInputException(1));
        ...
        public static int writeValue(JSONWriterUTF8 writer, byte[] buf, int off, List<String> values, long features) {
            if (STRING_VALUE != null) {
                return writeValueJDK11(writer, buf, off, values, features);
            } else {
                return writeValueJDK8(writer, buf, off, values, features);
            }
        }
        ...
        public static int writeBooleanNull(byte[] buf, int off, long features) {
            String raw = (features & (MASK_NULL_AS_DEFAULT_VALUE)) != 0 ? "false" : "null";
        ...
        public static int int64Capacity(List<Long> values) {
            return values == null ? 4 : values.size() * (23 /* long value size */ + 1);
        }
