...
- 支持`Android 8+` [(2.0.8.android)](https://repo1.maven.org/maven2/com/alibaba/fastjson2/fastjson2/2.0.8.android/)
- 支持`Graal Native-Image` [(2.0.8.graal)](https://repo1.maven.org/maven2/com/alibaba/fastjson2/fastjson2/2.0.8.graal/)
