...
final class ObjectReaderImplThaiBuddhistDate
        extends ObjectReaderPrimitive<ThaiBuddhistDate> {
    static final ObjectReaderImplThaiBuddhistDate INSTANCE = new ObjectReaderImplThaiBuddhistDate();

    ObjectReaderImplThaiBuddhistDate() {
        super(ThaiBuddhistDate.class);
    }

    @Override
    public ThaiBuddhistDate readJSONBObject(JSONReader jsonReader, Type fieldType, Object fieldName, long features) {
        String str = jsonReader.readString();
        if (str == null || str.isEmpty()) {
            return null;
        }
        return (ThaiBuddhistDate) parseChronoLocalDate(str, ThaiBuddhistChronology.INSTANCE);
    }

    @Override
    public ThaiBuddhistDate readObject(JSONReader jsonReader, Type fieldType, Object fieldName, long features) {
        String str = jsonReader.readString();
        if (str == null) {
            return null;
        }
