...
public abstract class FunctionAccessor<T>
    ...
    public FunctionAccessor(
        ...
        this(name, propertyType, propertyClass, getter, setter, (p, e) -> (RuntimeException) e);
    }
     ...
     */
    RuntimeException errorForSet(Throwable e) {
        if (exceptionHandler != null) {
            return exceptionHandler.apply(this, e);
        }
