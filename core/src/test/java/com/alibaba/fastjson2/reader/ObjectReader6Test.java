...
public class ObjectReader6Test {
    ...
    public void test1() {
        ...
        assertEquals(
                "[" +
                        "[0,0,0,0,0,0],[101,0,0,0,0,0],[201,202,0,0,0,0],[301,302,303,0,0,0],[401,402,403,0,0,0]," +
                        "[501,502,503,504,0,0],[601,602,603,604,0,0],[701,702,703,704,705,0]," +
                        "[801,802,803,804,805,0],[901,902,903,904,905,906]," +
                        "[1001,1002,1003,1004,1005,1006],[1101,1102,1103,1104,1105,1106],[1201,1202,1203,1204,1205,1206]" +
                        "]",
                JSON.toJSONString(
                        JSONB.parseObject(
                                JSONArray.of(
