...
public class StringField20Test {
    ...
    public StringField20Test() throws Exception {
        InputStream is = StringField20Test.class.getClassLoader().getResourceAsStream("data/String20.json");
...
//            System.out.println(vo.getV0000());
    ...
    public void test_asm_parse() throws Throwable {
        ObjectReader<StringField20> objectConsumer = ObjectReaderCreatorASM.of(StringField20.class);
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            long millis = System.currentTimeMillis() - start;
            System.out.println("Long20 asm millis : " + millis); // 1390
//            System.out.println(vo.getV0000());
        }
        System.out.println();
    }
    ...
    public void test_f12_parse() throws Throwable {
        for (int i = 0; i < 10; ++i) {
            ...
            long millis = System.currentTimeMillis() - start;
            System.out.println("Long20 f12 millis : " + millis); // 3471
//            System.out.println(vo.getV0000());
        }
        System.out.println();
    }
