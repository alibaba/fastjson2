...
//        }
        ...
        if (fieldClass == LocalDate.class && isLocalDateDefaultObjectWriter(provider)) {
            return new FieldWriterLocalDate(fieldName, ordinal, features, format, locale, label, fieldType, fieldClass, field, null, null);
        }

        if (fieldClass == OffsetDateTime.class && isOffsetDateTimeDefaultObjectWriter(provider)) {
        ...
        if (fieldClass == List.class || fieldClass == ArrayList.class || fieldClass == Iterable.class) {
            ...
            return new FieldWriterList(fieldName, itemType, ordinal, features, format, label, fieldType, fieldClass, field, null, contentAs);
        }
        ...
        if (fieldClass.isArray() && !fieldClass.getComponentType().isPrimitive()) {
            ...
            return new FieldWriterObjectArray(fieldName, itemClass, ordinal, features, format, label, field.getGenericType(), fieldClass, field, null, null);
        }
    ...
    public <T> FieldWriter<T> createFieldWriter(
        ...
        if (fieldClass == float.class) {
            return new FieldWriterFloatValue(fieldName, ordinal, features, format, label, fieldType, fieldClass, field, method, null);
        }

        if (fieldClass == Float.class) {
            return new FieldWriterFloat(fieldName, ordinal, features, format, label, fieldType, fieldClass, field, method, null);
        }
...
//        }
        ...
        if (fieldClass == List.class || fieldClass == ArrayList.class || fieldClass == Iterable.class) {
            ...
            return new FieldWriterList(fieldName, itemType, ordinal, features, format, label, fieldType, fieldClass, null, method, contentAs);
        }
    ...
    public <T> FieldWriter createFieldWriter(String fieldName, ToLongFunction<T> function) {
        return new FieldWriterInt64Val(fieldName, 0, 0, null, null, null, null, function);
    }
    ...
    public <T> FieldWriter createFieldWriter(String fieldName, ToIntFunction<T> function) {
        return new FieldWriterInt32Val(fieldName, 0, 0, null, null, null, null, function);
    }
    ...
    public <T> FieldWriter createFieldWriter(String fieldName, Field field, Method method, ToIntFunction<T> function) {
        return new FieldWriterInt32Val(fieldName, 0, 0, null, null, field, method, function);
    }
    ...
    public <T> FieldWriter createFieldWriter(String fieldName, ToShortFunction<T> function) {
        return new FieldWriterInt16Val(fieldName, 0, 0, null, null, null, null, function);
    }
    ...
    public <T> FieldWriter createFieldWriter(String fieldName, ToByteFunction<T> function) {
        return new FieldWriterInt8Val(fieldName, 0, 0, null, null, null, null, function);
    }
    ...
    public <T> FieldWriter createFieldWriter(String fieldName, ToFloatFunction<T> function) {
        return new FieldWriterFloatValue(fieldName, 0, 0L, null, null, float.class, float.class, null, null, function);
    }
    ...
    public <T, V> FieldWriter<T> createFieldWriter(
        ...
        if (fieldClass == Byte.class) {
            return new FieldWriterInt8(fieldName, ordinal, features, format, label, fieldClass, field, method, function);
        }

        if (fieldClass == Short.class) {
            return new FieldWriterInt16(fieldName, ordinal, features, format, label, fieldClass, field, method, function);
        }

        if (fieldClass == Integer.class) {
            return new FieldWriterInt32(fieldName, ordinal, features, format, label, fieldType, fieldClass, field, method, function);
        }

        if (fieldClass == Long.class) {
            return new FieldWriterInt64(fieldName, ordinal, features, format, label, fieldClass, field, method, function);
        }
    ...
    private static boolean isOffsetDateTimeDefaultObjectWriter(ObjectWriterProvider provider) {
        return provider == null || provider.getObjectWriter(OffsetDateTime.class) == ObjectWriterImplOffsetDateTime.INSTANCE;
    }

    private static boolean isLocalDateDefaultObjectWriter(ObjectWriterProvider provider) {
        return provider == null || provider.getObjectWriter(LocalDate.class) == ObjectWriterImplLocalDate.INSTANCE;
    }

    private static boolean isDefaultUUIDObjectWriter(ObjectWriterProvider provider) {
        return provider == null || provider.getObjectWriter(UUID.class) == ObjectWriterImplUUID.INSTANCE;
    }
    ...
    <T> FieldWriter<T> createFieldWriterLambda(
        ...
        if (fieldClass == int.class) {
            return new FieldWriterInt32Val(fieldName, ordinal, features, format, label, field, method, (ToIntFunction<T>) lambda);
        }
        ...
        if (fieldClass == short.class) {
            return new FieldWriterInt16Val(fieldName, ordinal, features, format, label, field, method, (ToShortFunction) lambda);
        }

        if (fieldClass == byte.class) {
            return new FieldWriterInt8Val(fieldName, ordinal, features, format, label, field, method, (ToByteFunction) lambda);
        }

        if (fieldClass == float.class) {
            return new FieldWriterFloatValue(fieldName, ordinal, features, format, label, fieldType, fieldClass, field, method, (ToFloatFunction) lambda);
        }

        if (fieldClass == Float.class) {
            return new FieldWriterFloat(fieldName, ordinal, features, format, label, fieldType, fieldClass, field, method, (Function) lambda);
        }
