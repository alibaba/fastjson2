...
public class IncricacyArrayTest extends MockJson {

    private final static String expectPath = "diff/array/IntricacyArraysActual.json";

    private final static String actualPath = "diff/array/IncricacyArraysActual.json";
