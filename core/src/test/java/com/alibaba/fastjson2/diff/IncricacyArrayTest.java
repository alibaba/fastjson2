...
public class IncricacyArrayTest
        extends MockJson {
    private static final String expectPath = "diff/array/IntricacyArraysActual.json";
    private static final String actualPath = "diff/array/IncricacyArraysActual.json";
