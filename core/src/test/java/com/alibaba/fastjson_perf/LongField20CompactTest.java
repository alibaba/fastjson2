...
public class LongField20CompactTest {
    private String str;

    public LongField20CompactTest() throws Exception {
        InputStream is = LongField20CompactTest.class.getClassLoader().getResourceAsStream("data/Long20_compact.json");
...
//            System.out.println(vo.getV0000());
    ...
    public void test_asm_parse() throws Throwable {
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            long millis = System.currentTimeMillis() - start;
            System.out.println("Long20 asm millis : " + millis); // 1447 1313
//            System.out.println(vo.getV0000());
        }
        System.out.println();
    }
    ...
    public void test_f12_parse() throws Throwable {
        for (int i = 0; i < 10; ++i) {
            ...
            long millis = System.currentTimeMillis() - start;
            System.out.println("Long20 f12 millis : " + millis); // 1088
//            System.out.println(vo.getV0000());
        }
        System.out.println();
    }
