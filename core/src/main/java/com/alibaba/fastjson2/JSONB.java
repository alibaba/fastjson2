...
import static com.alibaba.fastjson2.JSONB.Constants.BC_ARRAY_FIX_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_BIGINT;
import static com.alibaba.fastjson2.JSONB.Constants.BC_BIGINT_LONG;
import static com.alibaba.fastjson2.JSONB.Constants.BC_BINARY;
import static com.alibaba.fastjson2.JSONB.Constants.BC_DECIMAL;
import static com.alibaba.fastjson2.JSONB.Constants.BC_DECIMAL_LONG;
import static com.alibaba.fastjson2.JSONB.Constants.BC_DOUBLE;
import static com.alibaba.fastjson2.JSONB.Constants.BC_DOUBLE_LONG;
import static com.alibaba.fastjson2.JSONB.Constants.BC_DOUBLE_NUM_0;
import static com.alibaba.fastjson2.JSONB.Constants.BC_DOUBLE_NUM_1;
import static com.alibaba.fastjson2.JSONB.Constants.BC_FALSE;
import static com.alibaba.fastjson2.JSONB.Constants.BC_FLOAT;
import static com.alibaba.fastjson2.JSONB.Constants.BC_FLOAT_INT;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT16;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_BYTE_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_BYTE_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_BYTE_ZERO;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_NUM_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_NUM_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_SHORT_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_SHORT_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT32_SHORT_ZERO;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_BYTE_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_BYTE_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_INT;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_NUM_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_NUM_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_SHORT_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.BC_INT64_SHORT_MIN;
...
import static com.alibaba.fastjson2.JSONB.Constants.BC_REFERENCE;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_ASCII;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_ASCII_FIX_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_GB18030;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_UTF16;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_UTF16BE;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_UTF16LE;
import static com.alibaba.fastjson2.JSONB.Constants.BC_STR_UTF8;
import static com.alibaba.fastjson2.JSONB.Constants.BC_SYMBOL;
import static com.alibaba.fastjson2.JSONB.Constants.BC_TIMESTAMP;
import static com.alibaba.fastjson2.JSONB.Constants.BC_TIMESTAMP_MILLIS;
import static com.alibaba.fastjson2.JSONB.Constants.BC_TIMESTAMP_MINUTES;
import static com.alibaba.fastjson2.JSONB.Constants.BC_TIMESTAMP_SECONDS;
import static com.alibaba.fastjson2.JSONB.Constants.BC_TIMESTAMP_WITH_TIMEZONE;
...
import static com.alibaba.fastjson2.JSONB.Constants.INT32_BYTE_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.INT32_BYTE_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.INT32_SHORT_MAX;
import static com.alibaba.fastjson2.JSONB.Constants.INT32_SHORT_MIN;
import static com.alibaba.fastjson2.JSONB.Constants.INT64_NUM_HIGH_VALUE;
import static com.alibaba.fastjson2.JSONB.Constants.INT64_NUM_LOW_VALUE;
import static com.alibaba.fastjson2.JSONB.Constants.STR_ASCII_FIX_LEN;
...
public interface JSONB {
    ...
    static <T> T parseObject(byte[] jsonbBytes, Type objectType) {
        ...
        T object = (T) objectReader.readJSONBObject(jsonReader, 0);
        if (jsonReader.resolveTasks != null) {
            jsonReader.handleResolveTasks(object);
        }
        return object;
        ...
        try (JSONReader jsonReader = new JSONReaderJSONB(
            ...
            if (objectClass == Object.class) {
                ...
                if (type == BC_TYPED_ANY) {
                    ...
                    object = autoTypeObjectReader.readJSONBObject(jsonReader, ctx.features);
                } else {
                    object = jsonReader.readAny();
                }
            } else {
