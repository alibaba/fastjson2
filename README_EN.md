...
- Supports Android 8+ [(2.0.9.android)](https://repo1.maven.org/maven2/com/alibaba/fastjson2/fastjson2/2.0.9.android/)
- Supports `Graal Native-Image` [(2.0.9.graal)](https://repo1.maven.org/maven2/com/alibaba/fastjson2/fastjson2/2.0.9.graal/)
...
```groovy
dependencies {
    implementation 'com.alibaba.fastjson2:fastjson2-extension:2.0.9'
}
```
