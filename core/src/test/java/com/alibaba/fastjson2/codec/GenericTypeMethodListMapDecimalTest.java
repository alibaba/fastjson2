...
public class GenericTypeMethodListMapDecimalTest {
    @Test
    public void testRead_0() {
        ...
        for (ObjectReaderCreator creator : creators) {
            ...
            assertEquals(BigDecimal.valueOf(101), ((Map) vo.getValue().get(0)).get("0"));
        }
    }
    ...
    public static class P<T> {
        private List<Map<String,T>> value;

        public List<Map<String, T>> getValue() {
            return value;
        }

        public void setValue(List<Map<String, T>> value) {
            this.value = value;
        }
    }
    ...
    public static class P21<T extends BigDecimal> extends P2<T> {
    ...
    public static class P311<T extends BigDecimal> extends P31<T> {
