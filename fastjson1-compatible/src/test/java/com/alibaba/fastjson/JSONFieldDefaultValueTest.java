...
public class JSONFieldDefaultValueTest {
    @Test
    ...
    public static class Model {
        ...
        public Model(String string, boolean aBoolean, int anInt, short aShort, char aChar, byte aByte, long aLong, float aFloat, double aDouble, Boolean aBoolean2, Integer integer, Short aShort2, Character character, Byte aByte2, Long aLong2, Float aFloat2, Double aDouble2) {
            this.string = string;
