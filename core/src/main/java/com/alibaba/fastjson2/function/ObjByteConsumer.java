...
/**
 * Represents an operation that accepts an object-valued and a {@code byte}-valued argument,
 * and returns no result. This is the {@code (reference, byte)} specialization of {@link java.util.function.BiConsumer}.
