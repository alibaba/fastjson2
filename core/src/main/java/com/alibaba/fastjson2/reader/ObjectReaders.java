...
public class ObjectReaders {
    ...
    public static <T> FieldReader fieldReaderBool(String fieldName, ObjBoolConsumer<T> function) {
        return new FieldReaderBoolValue<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderByte(String fieldName, ObjByteConsumer<T> function) {
        return new FieldReaderInt8Value<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderShort(String fieldName, ObjShortConsumer<T> function) {
        return new FieldReaderInt16Value<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderInt(String fieldName, ObjIntConsumer<T> function) {
        return new FieldReaderInt32Value<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderLong(String fieldName, ObjLongConsumer<T> function) {
        return new FieldReaderInt64Value<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderChar(String fieldName, ObjCharConsumer<T> function) {
        return new FieldReaderCharValue<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderFloat(String fieldName, ObjFloatConsumer<T> function) {
        return new FieldReaderFloatValue<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }

    public static <T> FieldReader fieldReaderDouble(String fieldName, ObjDoubleConsumer<T> function) {
        return new FieldReaderDoubleValue<>(fieldName, 0, 0L, null, null, null, null, null, null, function, null, null);
    }
...
//        return new FieldReaderObjectFunc2<>(fieldObjectReader, consumer, fieldType, fieldName);
    ...
    public static <T, V> FieldReader fieldReaderList(
        ...
        return new FieldReaderList<>(fieldName, List.class, List.class, itemType, TypeUtils.getClass(itemType), 0, 0, null, null, null, null, null, null, function, null, null, listCreator, itemObjectReader);
    }
    ...
    public static <T, V> FieldReader fieldReaderList(
        ...
        return new FieldReaderList<>(fieldName, List.class, List.class, itemType, TypeUtils.getClass(itemType), 0, 0, null, null, null, null, null, null, function, null, null, listCreator, null);
    }
    ...
    public static <T> FieldReader fieldReaderListStr(
        ...
        return new FieldReaderList<>(fieldName, List.class, List.class, String.class, String.class, 0, 0, null, null, null, null, null, null, function, null, null, ArrayList::new, null);
    }
