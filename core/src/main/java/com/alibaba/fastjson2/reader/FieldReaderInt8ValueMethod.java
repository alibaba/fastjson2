...
final class FieldReaderInt8ValueMethod<T>
    ...
    FieldReaderInt8ValueMethod(String fieldName, Type fieldType, Class fieldClass, int ordinal, long features, String format, Locale locale, Byte defaultValue, Method setter) {
