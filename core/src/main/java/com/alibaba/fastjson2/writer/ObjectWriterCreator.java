...
//            }
    ...
    public <T, V> FieldWriter<T> createFieldWriter(
        ...
        if (fieldClass == Byte.class) {
            return new FieldWriterInt8<>(fieldName, ordinal, features, format, locale, label, fieldClass, fieldClass, field, method, function);
        }

        if (fieldClass == Short.class) {
            return new FieldWriterInt16<>(fieldName, ordinal, features, format, locale, label, fieldClass, fieldClass, field, method, function);
        }
    ...
    <T> FieldWriter<T> createFieldWriterLambda(
        ...
        if (fieldClass == short.class) {
            return new FieldWriterInt16Value<>(fieldName, ordinal, features, format, locale, label, fieldClass, fieldClass, field, method, (ToShortFunction) lambda);
        }

        if (fieldClass == Short.class) {
            return new FieldWriterInt16<>(fieldName, ordinal, features, format, locale, label, fieldClass, fieldClass, field, method, (Function) lambda);
        }

        if (fieldClass == byte.class) {
            return new FieldWriterInt8Value<>(fieldName, ordinal, features, format, locale, label, fieldClass, fieldClass, field, method, (ToByteFunction) lambda);
        }

        if (fieldClass == Byte.class) {
            return new FieldWriterInt8<>(fieldName, ordinal, features, format, locale, label, fieldClass, fieldClass, field, method, (Function) lambda);
        }
