...
//            case FLOAT_NUM_1:
    ...
    public boolean nextIfName4Match6(int name1) {
        ...
        if (offset > end
                || (UNSAFE.getShort(bytes, BASE + offset - 3) & 0xFFFF | (bytes[offset - 1] << 16)) != name1) {
            return false;
        }
    ...
    public boolean nextIfName4Match9(long name1) {
        ...
        if (offset > end
                || (UNSAFE.getInt(bytes, BASE + offset - 6) & 0xFFFFFFFFL | ((long) UNSAFE.getShort(bytes, BASE + offset - 2) << 32)) != name1) {
            return false;
        }
    ...
    public boolean nextIfName4Match10(long name1) {
        ...
        if (offset > end
                || ((UNSAFE.getInt(bytes, BASE + offset - 7) & 0xFFFFFFFFL)
                | ((long) (UNSAFE.getShort(bytes, BASE + offset - 3) & 0xFFFF) << 32) | ((long) bytes[offset - 1] << 48)) != name1) {
            return false;
        }
