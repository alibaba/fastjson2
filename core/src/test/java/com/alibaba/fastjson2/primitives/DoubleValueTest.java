...
import com.alibaba.fastjson2.jsonb.JSONBTest;
import com.alibaba.fastjson2.writer.ObjectWriter;
import com.alibaba.fastjson2.writer.ObjectWriterCreator;
import com.alibaba.fastjson2_vo.DoubleValue1;
...
//        values[off++] = Double.MAX_VALUE;
    ...
    public void test_arrayMapping() {
        ...
        for (ObjectWriterCreator creator : creators) {
            ObjectWriter<DoubleValue1> objectWriter = creator.createObjectWriter(DoubleValue1.class);
    ...
    public void test_jsonb() {
        for (Double id : values) {
            ...
            DoubleValue1 v1 = JSONB.parseObject(jsonbBytes, DoubleValue1.class);
