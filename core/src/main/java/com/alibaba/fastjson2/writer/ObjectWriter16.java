...
public class ObjectWriter16<T>
    ...
    public final FieldWriter fieldWriter12;
    public final FieldWriter fieldWriter13;
    public final FieldWriter fieldWriter14;
    public final FieldWriter fieldWriter15;

    public ObjectWriter16(
            Class<T> objectClass,
            String typeKey,
            String typeName,
            long features,
        ...
        this.fieldWriter12 = fieldWriters.get(12);
        this.fieldWriter13 = fieldWriters.get(13);
        this.fieldWriter14 = fieldWriters.get(14);
        this.fieldWriter15 = fieldWriters.get(15);
    }
    ...
    protected void writeFieldsJSONB(JSONWriterJSONB jsonWriter, Object object) {
        ...
        fieldWriter10.writeJSONB(jsonWriter, object);
        fieldWriter11.writeJSONB(jsonWriter, object);
        fieldWriter12.writeJSONB(jsonWriter, object);
        fieldWriter13.writeJSONB(jsonWriter, object);
        fieldWriter14.writeJSONB(jsonWriter, object);
        fieldWriter15.writeJSONB(jsonWriter, object);
    }
    ...
    protected void writeFieldsUTF8(JSONWriterUTF8 jsonWriter, Object object) {
        ...
        fieldWriter11.writeUTF8(jsonWriter, object);
        fieldWriter12.writeUTF8(jsonWriter, object);
        fieldWriter13.writeUTF8(jsonWriter, object);
        fieldWriter14.writeUTF8(jsonWriter, object);
        fieldWriter15.writeUTF8(jsonWriter, object);
    }
    ...
    protected void writeFieldsUTF16(JSONWriterUTF16 jsonWriter, Object object) {
        ...
        fieldWriter11.writeUTF16(jsonWriter, object);
        fieldWriter12.writeUTF16(jsonWriter, object);
        fieldWriter13.writeUTF16(jsonWriter, object);
        fieldWriter14.writeUTF16(jsonWriter, object);
        fieldWriter15.writeUTF16(jsonWriter, object);
    }
}
