...
public class Issue3689 {
    ...
    public void test_without_type_0_meaningles_char() {
        assertThrows(com.alibaba.fastjson.JSONException.class, () -> JSONArray.parseArray("dfdfdf"));
    }
    ...
    public void test_with_type_0_meaningles_char() {
        assertThrows(com.alibaba.fastjson.JSONException.class, () -> JSONArray.parseArray("dfdfdf", String.class));
    }
    ...
    public void test_with_type_6_meaningles_char() {
        assertThrows(JSONException.class, () -> JSONArray.parseArray("//////dfdfdf", String.class));
    }
