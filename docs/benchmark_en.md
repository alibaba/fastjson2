...
# 2. Direct JMH Performance Comparison
## 2.1 Test Environment
* MacBook Pro (16-inch, 2021) MacApple M1 Max, 64GB Memory
* ZuluJDK

## 2.1.1 Versions Compared
* Fastjson 2.0.1
* Fastjson 1.2.79
* Jackson 2.12.4
...
## 2.2 Parse Performance Comparison
* Test code https://github.com/alibaba/fastjson2/blob/2.0.1/core/src/test/java/com/alibaba/fastjson_perf/eishay/EishayParse.java


### 2.2.1 Scenario Introduction and Conclusion
* **EishayParseTreeString** scenario: Parsing a String into `JSONObject`/`JSONArray` or `HashMap`/`ArrayList`. In this scenario, fastjson2 shows twice the performance of fastjson1.
* **EishayParseString** scenario: Deserializing a String into a JavaBean object. In this scenario, fastjson2 has a 30% performance improvement over fastjson1.
* **EishayParseStringPretty**: Deserializing a formatted String with spaces, newlines, and indentation into a JavaBean object. fastjson2 is 3.44 times faster than fastjson1. This was a weak point for fastjson1, but with a new parsing algorithm in fastjson2, the performance has been greatly improved.
* **EishayParseUTF8Bytes**: Deserializing a UTF8-formatted `byte[]` into a JavaBean object.
...
## 2.3 WriteString
* Test code https://github.com/alibaba/fastjson2/blob/2.0.1/core/src/test/java/com/alibaba/fastjson_perf/eishay/EishayWrite.java

### 2.3.1 Scenario Introduction and Conclusion
* **EishayWriteString** scenario: Serializing a JavaBean object into a string. In this scenario, fastjson2 shows performance improvements of 164% and 85% over fastjson1 and jackson, respectively.
* **EishayWriteUTF8Bytes** scenario: Serializing a JavaBean object into a UTF8-formatted byte array. In this scenario, fastjson2 shows performance improvements of 185% and 93% over fastjson1 and jackson, respectively.
