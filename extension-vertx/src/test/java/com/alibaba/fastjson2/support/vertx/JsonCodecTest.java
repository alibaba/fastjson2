...
//                "myboolean\":true,\"mybyte\":124,\"mybinary\":\"" + strBytes + "\",\"mybuffer\":\"" + strBytes + "\",\"myinstant\":\"" + strInstant + "\",\"mynull\":null,\"myobj\":{\"foo\":\"bar\"},\"myarr\":[\"foo\",123]}";
        String json = "{\"myfloat\":1.23,\"mybuffer\":\"" + strBytes + "\",\"mybyte\":124,\"" +
                "mybinary\":\"" + strBytes + "\",\"myinstant\":\"" + strInstant + "\",\"myarr\":[\"foo\",123],\"" +
                "mynull\":null,\"myboolean\":true,\"myobj\":{\"foo\":\"bar\"},\"mylong\":1234,\"mydouble\":2.34,\"myint\":123,\"mystr\":\"foo\"}";
...
//        }
    ...
    public void testEncodeCollectionState() {
        ...
        if (codec instanceof Fastjson2Codec) {
