...
| PrettyFormatInlineArrays          | Used with PrettyFormat, keeps array elements on a single line instead of each element on a separate line. Matches original fastjson behavior.                                                                          |
